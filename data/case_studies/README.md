...
Planned v1.4 contract-stage process-quality case study. This is not a
completed Smart Factory implementation and does not include raw manufacturing
data, model training, dashboards, or production-control claims.
...
- Leakage map for post-outcome, future-window, group/time split, and hidden
  proxy risks
- Dataset candidate assessment links and readiness plan
