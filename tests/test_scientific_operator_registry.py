...
def test_default_operator_registry_has_selected_operators_only():
    ...
    assert "one_dimensional_diffusion_exact_propagator_v1" in operator_ids
    assert "one_dimensional_diffusion_ftcs_propagator_v1" in operator_ids
    assert "one_dimensional_diffusion_benchmark_evaluator_v1" in operator_ids
