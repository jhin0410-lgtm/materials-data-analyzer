...
- [Reliability v1.5 Plan](RELIABILITY_V1_5_PLAN.md): generic reliability/risk contract, dataset candidate assessment, Backblaze access gate, full-year readiness reassessment, leakage map, and validation hierarchy.
...
- [Reliability readiness planning](../data/case_studies/reliability/): asset-level reliability/risk contract, leakage map, candidate dataset assessment, and Backblaze full-year normalization readiness audit for future work.
