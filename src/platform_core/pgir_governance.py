...
CURRENT_IMPLEMENTATION_REFS = (
    ...
    "src.platform_core.battery_trajectory_evaluator",
)
...
def build_current_mapping_matrix() -> tuple[PGIRMappingRecord, ...]:
    ...
    return (
        ...
        PGIRMappingRecord(
            "src.platform_core.battery_trajectory_evaluator",
            "Deterministic Battery capacity-trajectory consistency evaluator",
            ("operator", "result", "provenance", "uncertainty"),
            "partial",
            "bounded descriptive evaluator",
            "local row-level findings plus tracked compact aggregates",
            "battery_capacity_trajectory_result_schema_v1",
            "1",
            ownership_module="src.platform_core.battery_trajectory_evaluator",
            uncertainty_support="source uncertainty unavailable; thresholds are algorithmic detection policy",
            current_domain_use=("battery_v2_3_4_capacity_trajectory_audit",),
            current_limitations=("cycle-index domain only", "no external validation", "no physical parameter fitting"),
            prohibited_promotions=("degradation mechanism confirmation", "SOH/RUL prediction", "production decision"),
            **common,
        ),
    )
...
def build_schema_ownership_registry() -> tuple[PGIRSchemaOwnershipRecord, ...]:
    return (
        ...
        PGIRSchemaOwnershipRecord("external_source_system_schema_v1", "1", "src.platform_core.external_source_contracts", "ExternalSourceSystemRecord.from_mapping", "ExternalSourceSystemRecord.to_dict", "explicit_compatibility_adapter", "data/platform/external_source_system_schema_v1.json", "stable", "active", "provenance", "metadata_only", "tracked_compact_metadata"),
        PGIRSchemaOwnershipRecord("external_dataset_schema_v1", "1", "src.platform_core.external_source_contracts", "ExternalDatasetRecord.from_mapping", "ExternalDatasetRecord.to_dict", "explicit_compatibility_adapter", "data/platform/external_dataset_schema_v1.json", "stable", "active", "provenance", "metadata_only", "tracked_compact_metadata"),
        PGIRSchemaOwnershipRecord("external_dataset_snapshot_schema_v1", "1", "src.platform_core.external_source_contracts", "ExternalDatasetSnapshotRecord.from_mapping", "ExternalDatasetSnapshotRecord.to_dict", "explicit_compatibility_adapter", "data/platform/external_dataset_snapshot_schema_v1.json", "stable", "active", "provenance", "metadata_only", "tracked_compact_metadata"),
        PGIRSchemaOwnershipRecord("external_distribution_artifact_schema_v1", "1", "src.platform_core.external_source_contracts", "ExternalDistributionArtifactRecord.from_mapping", "ExternalDistributionArtifactRecord.to_dict", "explicit_compatibility_adapter", "data/platform/external_distribution_artifact_schema_v1.json", "stable", "active", "provenance", "external_raw_local_only_compact_metadata_tracked", "tracked_compact_metadata"),
        PGIRSchemaOwnershipRecord("external_retrieval_event_schema_v1", "1", "src.platform_core.external_source_contracts", "ExternalRetrievalEventRecord.from_mapping", "ExternalRetrievalEventRecord.to_dict", "explicit_compatibility_adapter", "data/platform/external_retrieval_event_schema_v1.json", "stable", "active", "provenance", "metadata_only", "tracked_compact_metadata"),
        PGIRSchemaOwnershipRecord("external_source_provenance_assessment_schema_v1", "1", "src.platform_core.external_source_contracts", "ExternalSourceProvenanceAssessment.from_mapping", "ExternalSourceProvenanceAssessment.to_dict", "explicit_compatibility_adapter", "data/platform/external_source_provenance_assessment_schema_v1.json", "stable", "active", "provenance", "metadata_only", "tracked_compact_metadata"),
        ...
        PGIRSchemaOwnershipRecord("battery_capacity_trajectory_evaluator_config_schema_v1", "1", "src.platform_core.battery_trajectory_evaluator", "CapacityTrajectoryEvaluatorConfig.from_mapping", "CapacityTrajectoryEvaluatorConfig.to_dict", "none", "data/platform/battery_capacity_trajectory_evaluator_config_schema_v1.json", "additive_optional_fields", "active", "operator", "metadata_only", "tracked_compact_metadata"),
...
def build_capability_stage_registry() -> tuple[PGIRCapabilityStageRecord, ...]:
    return (
        ...
        PGIRCapabilityStageRecord("battery_capacity_trajectory_evaluator", "result", "scientifically_evaluated", "active_bounded", "v2_3_4_deterministic_capacity_trajectory_findings", ("src.platform_core.battery_trajectory_evaluator",), False, False, "bounded_descriptive_audit_only", ("cycle index is not physical time", "source uncertainty unavailable", "no external validation"), ("degradation mechanism confirmation", "physical parameter estimate", "SOH/RUL prediction", "production decision")),
    )
