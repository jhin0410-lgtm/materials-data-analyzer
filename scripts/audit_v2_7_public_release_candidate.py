"""Audit the promoted v2.7.0 public-release closeout.

The audit is offline. It verifies tracked release metadata and evidence without
creating tags or releases, rerunning scientific models, or accessing external
data.
"""
...
def build_summary(root: Path) -> dict[str, Any]:
    ...
    checks = {
        ...
        "v2_5_feature_line_released": (
            "Status: `released_within_v2.7.0`" in v25_roadmap
        ...
        "v2_6_line_closed_and_preserved": (
            "Status: `released_within_v2.7.0_line_closed`" in v26_roadmap
        ...
        "negative_results_preserved": (
            ...
            and "DWCNT, RWGS, four-carbon-material, and NIST cases: **Diagnostic**"
            in release_notes
        ),
    ...
    remaining_actions = [
        ...
        "Verify the v2.6.14 checksum closeout, representative NIST execution, and pinned cross-repository release audit on the promotion merge context.",
        "Create or verify an external v2.7.0 tag and GitHub Release only after the promotion commit is reviewed.",
    ]
...
Internal v2.5.x and v2.6.x labels remain development history, not separate
public releases.
